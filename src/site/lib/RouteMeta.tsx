...
const META: Record<string, Meta> = {
  ...
  "/work": {
    title: "Work | Garagol",
    desc: "Selected work from Garagol across strategy, brand, marketing, and engineering. Real outcomes, delivered end to end.",
    ld: [breadcrumb([["Home", "/"], ["Work", "/work"]])],
  },
  "/work/ignify": {
    title: "IGNIFY case study | Garagol",
    desc: "IGNIFY: a full-stack SaaS platform built from zero by Garagol. Native mobile apps, real-time messaging and calling, a secure cloud backend, payments, and an admin console.",
    ld: [IGNIFY_LD, breadcrumb([["Home", "/"], ["Work", "/work"], ["IGNIFY", "/work/ignify"]])],
  },
  "/services": {
    title: "Services | Garagol. Strategy, brand, marketing & engineering.",
    desc: "Four ways Garagol helps: Strategy & Consulting, Brand & Design, Marketing & Growth, and Build & Engineering. We advise and we build.",
    ld: [breadcrumb([["Home", "/"], ["Services", "/services"]])],
  },
  "/about": {
    title: "About | Garagol",
    desc: "Garagol is a digital consultancy and studio: senior strategists, designers, marketers, and engineers who advise and build across everything digital.",
  ...
  "/contact": {
    ...
    desc: "Start a project with Garagol. Get a tailored estimate in 5 questions, or send a quick inquiry. We reply within about 2 hours during business hours.",
